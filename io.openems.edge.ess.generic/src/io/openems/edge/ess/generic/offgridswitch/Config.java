...
@interface Config {
	...
	@AttributeDefinition(name = "Allowed min soc in off grid", description = " In case of grid failure battery-inverter and battery should stop if the soc is less than ")
	int allowedMinSocInOffGrid() default 5;

	@AttributeDefinition(name = "Allowed minimum cell voltage in off grid [mV]", description = " In case of grid failure battery-inverter and battery should stop if the minimum cell voltage is less than ")
	int allowedMinCellVoltageInOffGrid() default 2850;
